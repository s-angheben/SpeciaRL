...
export VERIFICATION_RUN_NAME="7b_verl_cub200_general_grpo_scala1"
export VERIFICATION_SUCCESS_STRATEGY="scala1"
...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.project_name='7b_verl_cub200_general_grpo_scala1' \
