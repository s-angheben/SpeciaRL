...
export VERIFICATION_RUN_NAME="7b_verl_cub200_general_dapo_reward3_ds"
export VERBOSE="true"
export VERIFICATION_SUCCESS_STRATEGY="reward3"
...
python3 -m recipe.dapo.main_dapo \
    ...
    trainer.project_name='7b_verl_cub200_general_dapo_reward3_ds' \
