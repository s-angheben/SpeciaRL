...
export VERIFICATION_RUN_NAME="7b_verl_cub200_general_grpo_noise_25"
export REWARD_MODE="all"
export VERBOSE="true"
export NOISE_PERCENTAGE=0.25

python3 -m verl.trainer.main_ppo \
    algorithm.adv_estimator=grpo \
    data.train_files=/workspace/vlm_openworld_evaluator/output/datasets/dataset_beec6de85d69c838a0835172fefc6d00536af68cef1c3c82dcb597d819449e3a.parquet \
    ...
    custom_reward_function.path=/workspace/verl/ow_rf/reward_best_prediction_dedup_noisy.py \
    custom_reward_function.name=compute_score_batch \
    trainer.critic_warmup=0 \
    'trainer.logger=["console","tensorboard"]' \
    trainer.project_name='7b_verl_cub200_general_grpo_noise_25' \
