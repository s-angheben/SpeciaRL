...
export VERIFICATION_RUN_NAME="7b_verl_cub200_general_grpo_noise_10"
export REWARD_MODE="all"
export VERBOSE="true"
export NOISE_PERCENTAGE=0.10
...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.project_name='7b_verl_cub200_general_grpo_noise_10' \
